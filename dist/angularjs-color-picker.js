  ...
  var AngularColorPickerController = function () {
      ...
      createClass(AngularColorPickerController, [{
          ...
          value: function onMouseUp(event) {
              ...
              if (!this.hueMouse && !this.opacityMouse && !(event.target.classList.contains('color-picker-grid-inner') || event.target.classList.contains('color-picker-picker') || event.target.parentNode.classList && event.target.parentNode.classList.contains('color-picker-picker'))) {
                  if (this.colorMouse) {
                      this.colorUp(event);
                  }
